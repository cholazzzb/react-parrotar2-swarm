...
/**
 * EXPERIMENT 3
 * Interval 1 second, control API -> go({x: targetX1, y: 0})
 */

const folderName = "Experiments/Data/Ex3";
const fileName = "EKFData_intervalgo_1m";
var targetX1 = 0;
...
try {
  client1.takeoff();
  client1.after(5000, () => {
    setInterval(intervaControl1, 3000);
  });
} catch (error) {
